    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href={{url("dashboard")}}>
                <img src={{asset("softui/img/logo-ct.png")}} class="navbar-brand-img h-100" alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link @yield('menuDashboard')" href={{url("dashboard")}}>
                        <div
                ...
                <li class="nav-item">
                    <a class="nav-link @yield('menuProduct')" href={{url("product")}}>
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link @yield('menuPayment')" href={{url("payment")}}>
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link @yield('menuOrders')" href={{url("orders")}}>
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <li class="nav-item">
                    <a class="nav-link @yield('menuUsers')" href={{url("users")}}>
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<script src={{asset("softui/js/plugins/chartjs.min.js")}}></script>
<script>
